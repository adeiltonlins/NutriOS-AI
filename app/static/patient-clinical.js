(() => {
  ...
  async function loadClinical() {
    const [planResponse, diaryResponse, questionnairesResponse] = await Promise.all([fetch("/paciente/api/plano"), fetch("/paciente/api/diario"), fetch("/paciente/api/questionarios")]);
