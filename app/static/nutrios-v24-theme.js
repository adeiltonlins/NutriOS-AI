(function(){
  ...
  function apply(){
    ...
    const themeMeta=document.querySelector('meta[name="theme-color"]');if(themeMeta)themeMeta.content='#f8faf9';
  ...
  function setupProfessionalShell(){
    ...
    addStylesheet('/static/nutrios-universal-light.css?v=4','universal-light');
    if(p==='/app'){
      addStylesheet('/static/nutrios-dashboard-premium.css?v=4','dashboard-premium');
      addStylesheet('/static/nutrios-dashboard-priority.css?v=4','dashboard-priority');
      addStylesheet('/static/nutrios-dashboard-layout-fix.css?v=4','dashboard-layout-fix');
      addScript('/static/nutrios-dashboard-premium.js?v=2','dashboard-premium');
      return;
    }
    addStylesheet('/static/nutrios-app-shell.css?v=6','app-shell');
    addScript('/static/nutrios-app-shell.js?v=5','app-shell');
  }
