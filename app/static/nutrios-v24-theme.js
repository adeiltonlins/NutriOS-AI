(function(){
  ...
  function apply(){
    ...
    const themeMeta=document.querySelector('meta[name="theme-color"]');if(themeMeta)themeMeta.content='#f4f7f5';
  ...
  function setupProfessionalShell(){
    ...
    addStylesheet('/static/nutrios-v2-suite.css?v=2','v2-suite');
    if(p==='/app'){
      ...
      addStylesheet('/static/nutrios-v2-shell.css?v=2','v2-shell');
